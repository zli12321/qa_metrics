...
#### Transformer Match
Our fine-tuned BERT model is on 🤗 [Huggingface]([https://huggingface.co/](https://huggingface.co/Zongxia/answer_equivalence_bert?text=The+goal+of+life+is+%5BMASK%5D.)). Our Package also supports downloading and matching directly. More Matching transformer models will be available 🔥🔥🔥
